<div id="create_event">
	...
	<h4>Event Name</h4>
	<input class="create_event_offset" type="text" required name="event_name" value="<?php echo set_value('event_name', ''); ?>" size="50" placeholder="Events name"/>
	<h4>Event Description</h4>
	<textarea class="create_event_offset" name="description" placeholder="Event description"><?php echo set_value('description', ''); ?></textarea>
	<h4>Event Location</h4>
	<textarea class="create_event_offset" name="location" required placeholder="Event location"><?php echo set_value('location', ''); ?></textarea>
	<h4>Start Date</h4>
	<input class="create_event_offset" type="date" required name="start_date" value="<?php echo set_value('start_date', ''); ?>" size="50" placeholder="Date of the first category"/>
	<h4>End Date</h4>
	<input class="create_event_offset" type="date" required name="end_date" value="<?php echo set_value('end_date', ''); ?>" size="50" placeholder="Date of the last category"/>
